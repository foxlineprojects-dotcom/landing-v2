          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-slate-600">
                We break down your car contract: What are you actually paying
                for? What's negotiable? What are the red flags? What questions
                should you ask before signing?
              </p>
            </div>
          </div>
        </section>
     ...
     <section id="about" className="bg-white py-16">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto space-y-4 text-lg text-slate-600">
              ...
              <p>
                I saw it all: the fine print tactics, the pressure techniques,
                the "add-ons" that mysteriously appeared on contracts. I watched
              ...
              <p>
                Years later, when I went to buy my own car, I thought I'd be
                fine. I knew the industry inside and out. I had all the
                knowledge and tools at my fingertips.
              </p>
              ...
              <p>
                I was talked down to. Dismissed. Treated like I couldn't
                possibly understand "the numbers." Even with all my insider
                knowledge,{" "}
                <span className="font-semibold text-slate-900">
                  I felt what every woman feels walking into a dealership: like
                  I needed an expert advisor or friend in my corner who would
